...
export const Users = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* 2. User List */}
      <div className="flex flex-col gap-2 max-h-[400px] overflow-y-auto pr-2 -scroll-my-80 scrollbar-thin scrollbar-thumb-neutral-700 scrollbar-track-transparent">
        {loading ? (
...
function User({ user }) {
  ...
  return (
    <div className="group flex justify-between items-center p-3 rounded-xl hover:bg-white/5 transition-colors  border border-transparent hover:border-white/5">
      ...
      <button
        ...
        className="flex items-center gap-2 cursor-pointer bg-purple-600/10 text-purple-400 hover:bg-purple-600 hover:text-white px-3 py-2 rounded-lg text-xs font-semibold transition-all active:scale-95"
      >
        Send
        <Send size={14} />
      </button>
