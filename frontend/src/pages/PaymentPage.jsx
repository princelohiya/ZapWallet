            ...
            <div className="h-full flex flex-col justify-center ">
                <div className="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                    ...
                    <div className=" flex justify-center ">
                        ...
                        <svg width="320" height="110" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="p-6">
                        <div className="space-y-4">
                            <h3 className=" text-2xl font-bold pb-0 p-10">Payment Successful</h3>
                            <div className=" flex flex-col justify-center h-ful pl-5">
                            <h6 className="  font-semibold pl-10"> Amount Paid : Rs. {amount}   </h6>
                            <h6 className="  font-semibold pl-10"> Paid To : {name}   </h6>
                            <h6 className="  font-semibold pl-10"> Balance : {props.balance}   </h6>
